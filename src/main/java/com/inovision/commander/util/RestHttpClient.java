...
public class RestHttpClient {
	...
	private void initialize() throws Exception {
		...
		SSLConnectionSocketFactory sslSocketFactory = new SSLConnectionSocketFactory(ctxBuilder.build(),
				SSLConnectionSocketFactory.ALLOW_ALL_HOSTNAME_VERIFIER);
		Registry<ConnectionSocketFactory> socketFactoryRegistry = RegistryBuilder.<ConnectionSocketFactory>create()
				.register("https", sslSocketFactory).register("http", PlainConnectionSocketFactory.getSocketFactory())
				.build();
		...
		RequestConfig requestConfig = RequestConfig.custom().setConnectTimeout(httpConnectionTimeout).setProxy(null)
